...
export const metadata: Metadata = {
  ...
  keywords: 'נציג שיחות AI, נציג טלפוני חכם, נציג טלפוני אוטומטי, נציג AI לעסקים, מענה טלפוני אוטומטי, בוט קולי, בוט קולי חכם, בוט קולי לעסקים, בוט קולי AI, מוקד שיחות AI, AI לעסקים, בינה מלאכותית לעסקים, פרוסאס, פרו סאס, ProSaaS',
  alternates: {
