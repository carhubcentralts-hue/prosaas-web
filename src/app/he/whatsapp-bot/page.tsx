...
export const metadata: Metadata = {
  ...
  keywords: 'בוט ווצאפ, בוט ווצאפ חכם, בוט וואטסאפ, בוט וואטסאפ חכם, נציג לוואטסאפ, בוט וואטסאפ לעסקים, אוטומציה וואטסאפ, מענה אוטומטי וואטסאפ, נציג ווצאפ אוטומטי, AI לעסקים, בינה מלאכותית לעסקים, פרוסאס, פרו סאס, ProSaaS',
  alternates: {
