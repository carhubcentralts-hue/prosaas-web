        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-lg">
            <div className="space-y-4">
              ...
              {status === 'success' && (
                <p className="text-green-600 text-center" role="status" aria-live="polite">{content.contact.form.success}</p>
              )}
              {status === 'error' && (
                <p className="text-red-600 text-center" role="alert" aria-live="assertive">{content.contact.form.error}</p>
              )}
            </div>
          </form>
          ...
          <div className="flex flex-col justify-center space-y-6">
            <a
              ...
              aria-label="פתח שיחה בוואטסאפ עם ProSaaS"
            >
            ...
            <a
              ...
              aria-label={`התקשר למספר ${content.contact.phone.number}`}
            >
